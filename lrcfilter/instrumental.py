...
from lrcfilter.config import MIN_SPEECH_DURATION, MIN_WORDS_FOR_VOCALS
from lrcfilter.models import InstrumentalResult, TranscriptionResult
...
def detect_instrumental(
    ...
    is_instrumental = (
        not transcription.has_speech
        or word_count < min_words_vocals
        or speech_duration < min_speech_duration
    )
